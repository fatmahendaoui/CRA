...
@Component({
  ...
  template: `
    ...
    <mat-form-field appearance="outline" >
        <mat-label>
        {{ 'features.day_off.name' | transloco }}        </mat-label>
        <input matInput  formControlName="name" />
      </mat-form-field>
    <mat-form-field>
  <mat-label>Date Day Off</mat-label>
  <input matInput [matDatepicker]="picker" disabled formControlName="date">
...
export class Edit_day_offComponent implements OnInit {
  private readonly bottomSheetRef = inject(MatBottomSheetRef<Edit_day_offComponent>);
